...
class LunchesControllerTest < ActionController::TestCase
  ...
  test "should create lunch" do
    assert_difference('Lunch.count') do
      post :create, lunch: { calories: @lunch.calories, cost: @lunch.cost, date: @lunch.date, rating: @lunch.rating }
    end
  ...
  test "should update lunch" do
    patch :update, id: @lunch, lunch: { calories: @lunch.calories, cost: @lunch.cost, date: @lunch.date, rating: @lunch.rating }
    assert_redirected_to lunch_path(assigns(:lunch))
  end
